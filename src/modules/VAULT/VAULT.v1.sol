...
abstract contract VAULTv1 is ERC4626, Module {
    ...
    function withdraw(uint256 assets, address receiver, address owner) public override permissioned returns (uint256) {}

    function redeem(uint256 shares, address receiver, address owner) public override permissioned returns (uint256) {}

    function deposit(uint256 assets, address receiver) public override permissioned returns (uint256) {}

    function mint(uint256 shares, address receiver) public override permissioned returns (uint256) {}
